        ...
        <footer class="main-footer">
            <div class="auto-container">
                <div class="footer-top">
                    <h1 style="color: #ffffff; font-size:40px; font-weight:600;">Contact Us</h1>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="contact-widget footer-widget ml_30">
                                ...
                                <div class="widget-content">
                                    <!-- <p>Tincidunt neque pretium lectus donec risus.</p> -->
                                    <ul class="info-list clearfix">
                                        <li><i class="icon-17"></i>At- Burat, Po- Madanpur Rampur, Kalahandi, Pin -766102, Odisha, India.</li>
                                        <li><i class="icon-18"></i><a href="mailto:mahashakti@mahashaktiindia.org">mahashakti@mahashaktiindia.org</a></li>
                                        <li><i class="icon-19"></i><a href="tel:3336660000">+91-81180 62107</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="contact-widget footer-widget ml_30">
                                ...
                                <div class="widget-content">
                                    ...
                                    <ul class="social-links">
                                        ...
                                        <li style="margin-top: 10px;"><a href="#" class="icon-youtube"><i class="fab fa-youtube"></i></a></li>
                                        <li style="margin-top: 10px;"><a href="#" class="icon-linkedin"><i class="fab fa-linkedin-in"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="footer-bottom centred">
                    <div class="copyright" style="text-align: center;">
                        <p style="font-size: 16px;">© 2024 Mahashakti Foundation. All Rights Reserved || Developed by <a href="#">CBSPL.</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total Visitors: <?php include("counter.php"); ?></p>
                    </div>
                </div>
            </div>
        </footer>
